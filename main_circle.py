...
# python main.py --save_path result --dataset circle --device 0 --data_type=iid --epochs=5000 --model=Diffusion --use_encoder --save_model --eval_interval=40 --n_run=1 --ecp_n_sim=100 --ecp_n_samples=200 --use_emperical_sigma 
